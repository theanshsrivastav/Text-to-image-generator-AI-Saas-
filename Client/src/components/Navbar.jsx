...
const Navbar = () => {
    ...
    return (
        <div className='flex items-center justify-between py-4'>
            <Link to="/">
                <img src={assets.logo} alt="logoImage" className='w-28 sm:w-32 lg:w-40' />
            </Link>
            ...
            <div>
                ...
                : 
                <div className='flex item-center gap-5 sm:gp-8'>
                    <p onClick = {()=>navigate('/buyCredit')} className='cursor-pointer py-2'>Pricing</p>
                    <button onClick={()=>setShowLogin(true)} className='bg-zinc-800 text-white px-7 py-2 sm:px-4 text-sm rounded-full'>Login</button>
                </div>
                }
            </div>
        </div>
